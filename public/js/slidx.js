...
$(document).ready(function () {
    ...
    //added logic to change position of close button as dynamic
    btnCloseRightSize=size;
    //var btnCloseRightSize = (size-(((jQuery(window).width()-jQuery('#main-navbar .container').width())/2)))-15;
